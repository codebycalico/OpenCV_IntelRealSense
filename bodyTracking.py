# Body tracking using Python and OpenCV
# Taken from Its-Triggy Joint_Track
...
class Joint:
	...
	smile_cascade = cv2.CascadeClassifier('C:\Users\crandall\OneDrive - OREGON MUSEUM OF SCIENCE AND INDUSTRY (OMSI)\Documents\opencv\sources\data\haarcascades\haarcascade_smile.xml')
